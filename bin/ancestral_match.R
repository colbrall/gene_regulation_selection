...
print(head(output))
f_out = paste("/project/mathilab/colbranl/gene_regulation_selection/tmp/", vcf$chr[1],"_",pop, "_AA.txt", sep = "") # ancestral allele file 
...
f_unmatched =  paste("/project/mathilab/colbranl/gene_regulation_selection/tmp/", vcf$chr[1],"_",pop, "_unmatched.tab", sep = "") # unmatched file 
...
sink(paste("/project/mathilab/colbranl/gene_regulation_selection/tmp/", vcf$chr[1],"_",pop, "_AA.log", sep = "")) # log file 
